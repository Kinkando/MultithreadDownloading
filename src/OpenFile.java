...
public class OpenFile extends javax.swing.JFrame {
    ...
    public OpenFile(String direc, String path) {
        initComponents();
        a = direc;
        b = path;
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(73, 161, 248));
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        File folder = new File(a); // path to the directory to be opened
...
//            setVisible(false);
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        // TODO add your handling code here:
        File folder = new File(b); // path to the directory to be opened
        Desktop desktop = null;
        if (Desktop.isDesktopSupported()) {
            desktop = Desktop.getDesktop();
        }
